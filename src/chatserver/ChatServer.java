			...
			try {
				...
				while ((message = reader.readLine()) != null) {
                                    if (message.toString().contains("¥")) {
                                        outputPane.append("Received: " + message.replace("¥",":") + "\n");
					data = message.split("¥");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(startButton, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(88, 88, 88)
                        .addComponent(stopButton, javax.swing.GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE)))
                .addContainerGap())
        );
		...
		while (it.hasNext()) {
			try {
				...
				writer.println(message);
                                outputPane.append("Sending: " + message.replace("¥", ":") + "\n");
                                writer.flush();
